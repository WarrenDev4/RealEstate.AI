...
const chartData = [
  {
    ...
    data: {
      ...
      datasets: [{ data: [60, 30, 10], backgroundColor: ["#007bff", "#6fb3fc", "#0d3d70"] }],
    },
  },
  {
    ...
    data: {
      ...
      datasets: [{ data: [50, 25, 25], backgroundColor: ["#007bff", "#6fb3fc", "#0d3d70"] }],
    },
  },
  {
    ...
    data: {
      ...
      datasets: [{ data: [40, 35, 25], backgroundColor: ["#007bff", "#6fb3fc", "#0d3d70"] }],
    },
  },
];
    ...
    <LayoutProvider>
      <div className="home-page">
        <h1
          ...
          style={{ fontFamily: "Inter, Poppins, Nunito, sans-serif", fontSize: "28px", color: "#171616" }}
        >
          Dashboard
        </h1>
        ...
        <section className={`recommendations ${fade ? "fade-out" : ""}`}>
          ...
          <div className="recommendation-list">
            <div className="recommendation-item" onClick={() => handleNavigation("/top-neighborhoods")}>
              🏡 Top neighborhoods to watch
            </div>
            <div className="recommendation-item" onClick={() => handleNavigation("/rising-values")}>
              📍 Rising property values
            </div>
            <div className="recommendation-item" onClick={() => handleNavigation("/investment-opportunities")}>
