      ...
      <div className="trends">
        ...
        <div className="grid-container">
          ...
          <div className="trend-card">
            ...
            <div className="chart-inner">
              <Bar data={propertyDemandData} options={chartOptions} />
            </div>
          </div>
          <div className="trend-card">
        ...
        <section className={`recommendations ${fade ? "fade-out" : ""}`}>
          <h2
            className="dashboard-title"
            style={{ fontFamily: "system-ui, sans-serif", fontSize: "18px", color: "#2e2c2c" }}
          >
            AI-Powered Analytics
          </h2>
          <div className="recommendation-list">
            <div className="recommendation-item" onClick={() => handleNavigation("/market-predictions")}>
              🏠 Market Predictions
            </div>
            <div className="recommendation-item" onClick={() => handleNavigation("/trend-analysis")}>
              📈 Trend Analysis
            </div>
            <div className="recommendation-item" onClick={() => handleNavigation("/investment-analytics")}>
